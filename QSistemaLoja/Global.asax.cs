...
namespace QSistemaLoja
{
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        {
            Database.SetInitializer(new MigrateDatabaseToLatestVersion<Models.QSistemaLojaContext, Migrations.Configuration>());
        ...
        private void AddPermissoesSuperUser(ApplicationDbContext db)
        {
            ...
            var user = userManager.FindByName("jpsilvafla@gmail.com");
        ...
        private void CriarSuperUser(ApplicationDbContext db)
        {
            ...
            if (user == null)
            {
                ...
                {
                    UserName = "jpsilvafla@gmail.com",
                    Email = "jpsilvafla@gmail.com"
                };

                userManager.Create(user, "Joao123#");
            }
        }
